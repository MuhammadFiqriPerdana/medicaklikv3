...
if (isset($_POST['import'])) {
  ...
  while ($ds = mysqli_fetch_array($datacart)) {
    ...
    if ($Ikembalian >= 0) {
      ...
      $UpdLap = mysqli_query($conn, "INSERT INTO laporan (invoice,kode_produk,nama_produk,harga,harga_modal,qty,subtotal,toko)
     SELECT invoice,kode_produk,nama_produk,harga,harga_modal,qty,subtotal,'" . $_SESSION['toko'] . "' FROM cart") or die(mysqli_connect_error());
