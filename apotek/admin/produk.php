      ...
      <form method="post">
        ...
        <div class="modal-body">
          <div class="form-group" id="scanner-container">
            ...
            <button class="btn btn-success" id="scan-btn">Scan Barcode</button>
          </div>
          ...
          <div id="interactive" class="viewport"></div>
            ...
            <script>
// Mendapatkan daftar perangkat media yang tersedia
navigator.mediaDevices.enumerateDevices()
  .then(function(devices) {
    ...
    // Membuat pilihan kamera dalam elemen select
...
// Fungsi untuk mengatur konstrain kamera berdasarkan deviceId
function setCameraConstraints(deviceId) {
  var constraints = {
    video: {
  ...
  // Menghentikan aliran media yang ada
  if (videoStream) {
  ...
  // Memulai kembali aliran media dengan konstrain kamera yang baru
  navigator.mediaDevices.getUserMedia(constraints)
    .then(function(stream) {
      // Menggunakan aliran media yang baru
      videoStream = stream;
            ...
            $(function() {
              ...
              Quagga.onProcessed(function(result) {
                ...
                if (result) {
                  ...
                  $('#btn-scan').on('click', function(event) {
  event.preventDefault();
